...
El alcance de este cubo se centra en la representación de **observaciones agregadas de gasto comercial**. El modelo describe el gasto a partir de las siguientes dimensiones:

| Dimensión | Descripción | IRI |
| --- | --- | --- |
| Región administrativa de referencia | Municipio, barrio o distrito | `edintdimension:refAdminRegion` |
| Periodo de referencia | Intervalo temporal | `edintdimension:refPeriod` |
| Sector | Sector temático de la observación | `edintdimension:sector` |
| Actividad económica | Clasificación controlada CNAE | `edintdimension:economicActivity` |
| Nacionalidad | Nacionalidad de los sujetos de la estadística | `edintdimension:nationality` |

La medida principal del cubo es el **importe del gasto comercial**:

| Medida | Descripción | IRI |
| --- | --- | --- |
| Importe del gasto comercial | Importe del gasto, como valor numérico | `edintmeasure:expenditureAmount` |

## Prefijo y espacio de nombres (Prefix and namespace)

El prefijo del cubo de datos es `edintgast` y se publica bajo el espacio de nombres https://edint.es/def/cubo-gasto-comercial#
...
| **examples/**      | Contiene ejemplos de uso del cubo de datos utilizados en la documentación.                                                                         |
